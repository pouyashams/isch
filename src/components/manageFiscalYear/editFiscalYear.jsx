...
class addFiscalYear extends Component {
    ...
    addFiscalYear = async() => {
        const data = {
            ...
            fiscalMonthList: [
                {
                    identifier:this.state.springId,
                    status: {
                ...
                {
                    identifier:this.state.summerId,
                    status: {
                ...
                {
                    identifier:this.state.autumnId,
                    status: {
                ...
                {
                    identifier:this.state.winterId,
                    status: {
    ...
    async componentDidMount() {
        ...
        dataInfo.fiscalMonthList.forEach((data) => {
            ...
            if (data.session.code==="SPRING"){
                this.setState({
                    springStatus: data.status.code,
                    springDescription: data.description,
                    springId:data.identifier
                });
            }else if(data.session.code==="FALL"){
                this.setState({
                    autumnStatus: data.status.code,
                    autumnDescription: data.description,
                    autumnId:data.identifier
                });
            }else if(data.session.code==="SUMMER"){
                this.setState({
                    summerStatus: data.status.code,
                    summerDescription: data.description,
                    summerId:data.identifier
                });
            }else if (data.session.code==="WINTER"){
                this.setState({
                    winterStatus: data.status.code,
                    winterDescription: data.description,
                    winterId:data.identifier
                });
            }
